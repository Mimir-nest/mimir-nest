...
export default function InterviewHowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-14 sm:py-20 md:py-28 px-4 sm:px-6 md:px-12 lg:px-16 bg-surface-container rounded-3xl border-y border-border/40 max-w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {steps.map((step) => {
            ...
            return (
              <div
                key={step.number}
                className="rounded-2xl bg-mn-background border border-outline-variant/60 p-5 sm:p-6 flex flex-col justify-between group hover:border-surface-tint/40 transition-all duration-300"
              >
                <div>
                  <div className="flex items-center justify-between mb-5 sm:mb-6">
                    <span className="font-mono text-xl sm:text-2xl font-bold text-surface-tint">
                      {step.number}
                    </span>
                    <div className="w-10 h-10 rounded-xl bg-surface-container flex items-center justify-center text-foreground group-hover:text-surface-tint group-hover:bg-surface-tint/10 transition-colors shrink-0">
                      <Icon className="w-5 h-5" />
                    </div>
                  </div>

                  <h3 className="font-headline-md text-base sm:text-lg font-bold text-foreground mb-2">
                    {step.title}
                  </h3>
        ...
        {/* Privacy Note */}
        <div className="mt-10 sm:mt-12 p-4 rounded-xl bg-surface-container-high/60 border border-outline-variant/50 max-w-3xl mx-auto text-center flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-2.5">
