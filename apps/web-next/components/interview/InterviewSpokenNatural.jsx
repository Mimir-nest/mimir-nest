    ...
    <section className="py-20 md:py-28 px-6 md:px-16 bg-surface-container rounded-3xl border-y border-border/40 max-w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 rounded-2xl bg-mn-background border border-outline-variant/70 p-6 md:p-8 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4 text-sm font-sans">
                ...
                <div className="space-y-1.5">
                  <span className="text-xs font-mono text-surface-tint font-semibold">AI Interviewer</span>
                  <div className="p-3.5 rounded-xl bg-surface-container border border-outline-variant/60 text-foreground/90 font-body-md">
                ...
                <div className="space-y-1.5 flex flex-col items-end">
                  <span className="text-xs font-mono text-muted-foreground font-semibold">Candidate (Spoken)</span>
                  <div className="p-3.5 rounded-xl bg-primary/10 border border-primary/25 text-foreground/95 max-w-[95%] font-body-md text-right">
                ...
                <div className="space-y-1.5">
                  <span className="text-xs font-mono text-surface-tint font-semibold">Adaptive Follow-Up</span>
                  <div className="p-3.5 rounded-xl bg-surface-container border border-surface-tint/30 text-foreground/90 font-body-md">
            ...
            <div className="mt-6 pt-4 border-t border-outline-variant/40 text-xs font-mono text-muted-foreground flex items-center gap-2">
              ...
              <span>Communicate complex technical reasoning fluently without artificial language barriers.</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 rounded-2xl bg-mn-background border border-outline-variant/70 p-6 md:p-8 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between pb-4 border-b border-outline-variant/40 mb-5">
                <span className="text-xs font-mono uppercase tracking-wider text-foreground font-semibold flex items-center gap-1.5">
                  <Cpu className="w-4 h-4 text-surface-tint" />
                  Conceptual Voice Pipeline
                </span>
              ...
              <div className="flex items-center gap-4 p-3.5 mb-5 rounded-xl bg-surface-container border border-outline-variant/60">
                ...
                <div className="text-xs font-mono space-y-1">
                  <div className="flex items-center gap-1.5 text-surface-tint font-semibold">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse" />
                    Spoken Reasoning Active
                  </div>
                  <p className="text-[11px] text-muted-foreground font-body-md">
                ...
                {conceptualPipeline.map((item) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span className="font-mono text-[11px] font-bold text-surface-tint">
                        {item.step}
                      </span>
            ...
            <div className="pt-4 border-t border-outline-variant/40">
              <div className="p-3 rounded-xl bg-surface-container-high/60 border border-outline-variant/50 text-xs text-on-surface-variant font-mono leading-relaxed">
