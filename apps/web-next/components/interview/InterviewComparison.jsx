    ...
    <section className="py-14 sm:py-20 md:py-28 px-4 sm:px-6 md:px-12 lg:px-16 bg-mn-background max-w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {/* Traditional Card */}
          <div className="rounded-2xl bg-surface-container/60 border border-outline-variant/60 p-5 sm:p-6 md:p-8 flex flex-col justify-between relative overflow-hidden">
            <div>
              <div className="flex items-center justify-between pb-6 border-b border-outline-variant/40 mb-6 gap-3">
                <div className="min-w-0">
                  <span className="text-xs font-mono uppercase tracking-wider text-muted-foreground/80 block">Standard Approach</span>
                  <h3 className="text-lg sm:text-xl font-bold text-foreground/80 mt-1 truncate">Traditional AI Interview</h3>
                </div>
                <div className="w-10 h-10 rounded-xl bg-surface-container-high border border-outline-variant flex items-center justify-center text-muted-foreground shrink-0">
                ...
                {comparisonItems.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-sm">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-on-surface-variant font-body-md break-words">{item.traditional}</span>
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <div className="rounded-2xl bg-surface-container border-2 border-surface-tint/40 p-5 sm:p-6 md:p-8 flex flex-col justify-between relative overflow-hidden shadow-xl shadow-surface-tint/5">
            <div className="absolute top-0 right-0 w-32 h-32 bg-surface-tint/5 rounded-bl-full pointer-events-none" />

            <div>
              <div className="flex items-center justify-between pb-6 border-b border-surface-tint/20 mb-6 gap-3">
                <div className="min-w-0">
                  <span className="text-xs font-mono uppercase tracking-wider text-surface-tint font-semibold block">Mimir Approach</span>
                  <h3 className="text-lg sm:text-xl font-bold text-foreground mt-1 flex flex-wrap items-center gap-2">
                    <span>Mimir Interview</span>
                ...
                <div className="w-10 h-10 rounded-xl bg-surface-tint/15 border border-surface-tint/30 flex items-center justify-center text-surface-tint shrink-0">
                ...
                {comparisonItems.map((item, idx) => (
                  <li key={idx} className="flex items-start gap-3 text-sm">
                    ...
                    <div className="min-w-0">
                      ...
                      <span className="text-foreground font-body-md font-medium break-words">{item.mimir}</span>
                    </div>
                  </li>
                ))}
              </ul>
            ...
            <div className="mt-8 pt-4 border-t border-surface-tint/20 text-xs font-mono text-surface-tint/90 flex items-center gap-2">
              ...
              <span className="break-words">Outcome: Deep confidence in defending your code, architectural tradeoffs, and design choices.</span>
            </div>
          </div>
        </div>
      </div>
