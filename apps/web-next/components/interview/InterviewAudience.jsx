        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {audiences.map((aud) => {
            ...
            return (
              <div
                key={aud.title}
                className="rounded-2xl bg-mn-background border border-outline-variant/60 p-5 sm:p-6 flex flex-col justify-between hover:border-surface-tint/40 transition-all duration-200"
              >
                <div>
                  <div className="w-10 h-10 rounded-xl bg-surface-container flex items-center justify-center text-surface-tint mb-4 shrink-0">
          ...
          <div className="rounded-2xl bg-surface-container-high/60 border border-surface-tint/20 p-5 sm:p-6 flex flex-col justify-center text-center">
            <span className="font-mono text-xs uppercase tracking-widest text-surface-tint mb-2 font-semibold">
              The Bottom Line
            </span>
            <p className="font-body-md text-sm text-foreground/90 font-medium leading-relaxed">
