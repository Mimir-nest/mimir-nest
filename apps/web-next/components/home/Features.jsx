...
import { BookMarked, Map, ArrowRight, Clock, Code, Mail } from "lucide-react";
import Link from "next/link";

const Features = () => {
  return (
    <section id="features" className="py-16 md:py-[120px] px-6 md:px-16 bg-mn-background max-w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:auto-rows-[280px]">
          ...
          {/* Card 4: Build (col-span-6, bg-primary-container) */}
          <Link
            href="/projects"
            className="md:col-span-6 h-72 md:h-auto rounded-2xl bg-primary-container relative overflow-hidden group flex flex-col justify-end p-6 md:p-10 cursor-pointer border border-border/30"
          >
            ...
            <div className="absolute inset-0 flex items-end justify-center gap-3 p-6 opacity-20">
              {[55, 75, 90, 60, 45, 80, 70, 50].map((h, i) => (
                <div
                  key={i}
            ...
            <div className="relative z-20 text-foreground">
              <span className="inline-block px-3 py-1 rounded-md border border-surface-tint/50 text-surface-tint font-label-caps text-label-caps mb-4 backdrop-blur-sm tracking-widest uppercase">
                Build
              </span>
              ...
              <p className="font-body-md text-body-md text-foreground/80 max-w-md">
                Project ideas and structured roadmaps for building practical skills.
              </p>
            </div>
          </Link>

          {/* Card 5: Prepare (col-span-6, bg-surface-container-lowest, border border-border) */}
          <Link
            href="/placement-dsa"
            className="md:col-span-6 rounded-2xl bg-surface-container-lowest border border-border p-6 md:p-10 flex flex-col sm:flex-row items-center gap-6 md:gap-8 group hover:border-surface-tint/30 transition-colors cursor-pointer"
          >
            <div className="flex-1">
              <span className="font-label-caps text-label-caps text-surface-tint tracking-widest block mb-4 uppercase">
                Prepare
              </span>
              ...
              <p className="font-body-md text-body-md text-on-surface-variant mb-6">
                DSA practice and technical interview preparation.
              </p>
