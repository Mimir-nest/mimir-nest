...
const StatsSection = ({ questions }) => {
    ...
    return (<motion.div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6" variants={statsVariants} initial="hidden" animate="visible" transition={{ delay: 0.8, duration: 0.3 }}>
      <div className="bg-surface-container/60 rounded-xl border border-border p-4 flex items-center gap-4 hover:border-surface-tint/30 transition-colors">
        <div className="p-3 bg-primary-container rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary"><path d="M21 12V7a5 5 0 0 0-5-5H8a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h5"/><path d="M21 12H12a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2z"/></svg>
        </div>
        <div>
      ...
      <div className="bg-surface-container/60 rounded-xl border border-border p-4 flex items-center gap-4 hover:border-surface-tint/30 transition-colors">
        <div className="p-3 bg-white/5 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground"><circle cx="12" cy="12" r="10"/><path d="m9 12 2 2 4-4"/></svg>
        </div>
        <div>
      ...
      <div className="bg-surface-container/60 rounded-xl border border-border p-4 flex items-center gap-4 hover:border-surface-tint/30 transition-colors">
        <div className="p-3 bg-surface-tint/15 rounded-lg">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-surface-tint"><path d="M12 2v20"/><path d="m2 12 20 0"/></svg>
        </div>
        <div>
